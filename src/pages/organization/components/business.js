	...
	return (
		<div>
			...
			<div class="flex flex-wrap justify-around gap-4">
				<div class="w-1/4 flex flex-col justify-between items-center p-4 shadow-lg mb-8">
					<div class="text-xl w-full text-center py-4 text-purple-700 border-b-2 border-purple-700">
						일상생활활동
					</div>
					<div class="text-center text-xl flex flex-col justify-center items-center py-8">
						<div>용모관리</div>
						<div>개인위생활동</div>
						<div>식사예절 익히기</div>
					</div>
