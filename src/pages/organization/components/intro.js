...
const Intro = () => {
	return (
		<div>
			...
			<div class="text-xl font-bold leading-9">늘사랑주간보호센터</div>
			<div class="text-lg mb-8 leading-9">
				늘사랑주간보호센터는 장애당사자의 역량강화, 자기결정권강화,
				사회통합지원을 통한 발달장애인의 행복한 삶을 미션으로 발달장애인이 낮
				시간 동안 함께 다양한 활동을 하는 곳입니다.
			</div>
			<div class="mb-16">
			...
			<div class="mb-16">
				...
				<div class="px-8 py-3 flex flex-row justify-center items-center border-b border-gray-300">
					...
					<div class="flex-1">포항시 발달장애인 (20세~60세)</div>
				</div>
				<div class="px-8 py-3 flex flex-row justify-center items-center border-b border-gray-300">
