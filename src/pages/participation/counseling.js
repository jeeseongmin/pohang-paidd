		...
		<div>
			<div class="flex flex-row justify-between items-center mb-8">
				...
				<Link
					...
					class="cursor-pointer px-2 md:px-16 py-2 border border-purple-700 text-purple-700 flex flex-row items-center hover:bg-purple-500 hover:text-white hover:font-bold"
				>
					작성하기
				</Link>
			</div>
			<div class="w-full h-auto mb-8">
				...
				<div class="cursor-pointer w-full px-2 lg:px-8 py-4 flex justify-end items-center border-b border-gray-300 hover:bg-gray-100">
					...
					<div class="text-base w-24 hidden md:block">21.05.01</div>
