		...
		<>
			...
			>
				...
				<Link
					...
					class="w-full md:w-auto justify-center cursor-pointer my-4 md:my-0 px-16 py-2 border border-purple-700 text-purple-700 flex flex-row items-center transition delay-50 duration-300 hover:bg-purple-500 hover:text-white hover:font-bold"
				>
					자원봉사 신청
				</Link>
				{currentEmail === "master" ? (
					<Link
						...
						onClick={() => document.getElementById("scrollRef").scrollTo(0, 0)}
						class="w-full md:w-auto justify-center cursor-pointer px-16 py-2 border border-purple-700 text-purple-700 flex flex-row items-center transition delay-50 duration-300 hover:bg-purple-500 hover:text-white hover:font-bold"
					>
						신청 내역
					</Link>
				) : null}
