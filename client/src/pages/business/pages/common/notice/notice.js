	...
	function NoticeBlock(props) {
		...
		return (
			<Link
				...
				class="cursor-pointer w-full px-2 lg:px-8 py-4 flex justify-end items-center border-b border-gray-300 hover:bg-gray-100 transition delay-50 duration-300"
			>
