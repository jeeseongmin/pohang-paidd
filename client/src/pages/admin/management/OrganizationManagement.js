                  ...
                  currentInfo.load ?
                    <div>
                      ...
                      <div class='text-base lg:text-lg mb-8 leading-7 lg:leading-9'>
                        ...
                        >{currentInfo.description}</div>
                      </div>
                      {
                        currentInfo.contents.length > 0 && currentInfo.contents.map((item, index) => {
                      ...
                      <div class='mb-16 text-sm lg:text-base'>
                        <div
                          class='px-2 lg:px-8 py-3 flex flex-row justify-start items-center border-b-2 border-purple-700'>
                          <div class='text-xl lg:text-2xl text-purple-700'>직원현황</div>
                        </div>
                        <div
                          class='px-2 lg:px-8 py-3 flex flex-row justify-center items-center border-b-2 border-purple-700'>
                          <div class='w-1/6'>
                        ...
                        {
                          currentInfo.employees.length > 0 && currentInfo.employees.map((item, index) => {
                            return <div
                              className='px-2 lg:px-8 py-3 flex flex-row justify-center items-center border-b border-gray-300'>
